...
- Clustering
image: featured.png
image-alt: Spatial distribution of the three *Aedes aegypti* ovitrap time series clusters obtained with the DTW, K-Shape and PAM algorithms in Córdoba.
---
...
![](featured.png){fig-alt="Spatial distribution of the three *Aedes aegypti* ovitrap time series clusters obtained with the DTW, K-Shape and PAM algorithms in Córdoba." .featured-figure}
